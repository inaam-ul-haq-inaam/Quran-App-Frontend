...
export default function PlayerControls({
  ...
  onNext,
  onPrevious,
  onSeek, // 👈 Hook se aaya hua seek function yahan pass karein
}) {
  const { position, duration } = useProgress();
    ...
    <View style={styles.container}>
      ...
      <View style={styles.progressContainer}>
        <Slider
          style={styles.slider}
          minimumValue={0}
          maximumValue={duration > 0 ? duration : 1} // Duration 0 hone par crash na ho
          value={position}
          minimumTrackTintColor="#1F4037"
          maximumTrackTintColor="#D3D3D3"
          thumbTintColor="#1F4037"
          // Sliding khatam hone par hook ka function call karein
      ...
      <View style={styles.controlsRow}>
        <TouchableOpacity onPress={onPrevious} style={styles.subButton}>
          <Ionicons name="play-skip-back" size={32} color="#1F4037" />
        </TouchableOpacity>
        ...
        <TouchableOpacity onPress={onNext} style={styles.subButton}>
          <Ionicons name="play-skip-forward" size={32} color="#1F4037" />
        </TouchableOpacity>
      </View>
    </View>
  );
